...
export class PodcastsResolver {
  ...
  async createPodcast(@Args('input') createPodcastDto: CreatePodcastDto): Promise<CoreOutput> {
    try {
  ...
  @Mutation((returns) => CoreOutput)
  async updatePodcast(@Args('input') updatePodcastDto: UpdatePodcastDto): Promise<CoreOutput> {
    try {
